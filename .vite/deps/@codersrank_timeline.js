...
// node_modules/@codersrank/timeline/esm/shared/fetch-data.js
var cache = {
  projects: {},
  work_experiences: {}
};
var fetchData = function fetchData2(username, type) {
  var endpoint = "work_experiences";
  if (type === "portfolio")
    endpoint = "projects";
  if (cache[endpoint][username])
    return Promise.resolve(cache[endpoint][username]);
  if (type === "technologies") {
    return Promise.all([fetchData2(username, "portfolio"), fetchData2(username, "workexperience")]).then(function(_ref) {
      var projects = _ref[0], work_experiences = _ref[1];
...
// node_modules/@codersrank/timeline/esm/shared/codersrank-logo.js
...
// node_modules/@codersrank/timeline/esm/shared/render.js
var render = function render2(_temp) {
  var _ref = _temp === void 0 ? {} : _temp, data = _ref.data, preloader = _ref.preloader, branding = _ref.branding, type = _ref.type;
  var _data$rows = data.rows, rows = _data$rows === void 0 ? [] : _data$rows, _data$years = data.years, years = _data$years === void 0 ? [] : _data$years;
  var itemText = function itemText2(item) {
    if (item.end_col - item.start_col < 2)
      return "";
...
// node_modules/@codersrank/timeline/esm/shared/render-error.js
var renderError = function renderError2() {
  return "";
};

// node_modules/@codersrank/timeline/esm/shared/render-loading.js
function _extends() {
...
var renderLoading = function renderLoading2(ctx) {
...
// node_modules/@codersrank/timeline/esm/shared/difference-in-months.js
var differenceInMonths = function differenceInMonths2(d1, d2) {
  var months;
...
// node_modules/@codersrank/timeline/esm/shared/format-data.js
function _extends2() {
...
var formatData = function formatData2(items, type) {
  if (items === void 0) {
    items = [];
  }
  var rows = [];
  ...
  var endDate;
  var totalCols;
  var datesOverlap = function datesOverlap2(start1, end1, start2, end2) {
  ...
  var techItems = [];
  var addTechItem = function addTechItem2(tech, start, end, item) {
    techItems.push({
      name: tech,
      start_date: start,
      end_date: end,
  ...
  var processTechItem = function processTechItem2(tech, item) {
    var start_date = item.start_date, end_date = item.end_date, is_current = item.is_current;
    var techStart = start_date ? new Date(start_date) : /* @__PURE__ */ new Date();
    var techEnd = end_date && !is_current ? new Date(end_date) : /* @__PURE__ */ new Date();
    ...
    if (!similarTechs.length) {
      ...
      similarTechs.forEach(function(otherTech) {
        if (overlap)
          return;
        var otherTechStart = otherTech.start_date ? new Date(otherTech.start_date) : /* @__PURE__ */ new Date();
        var otherTechEnd = otherTech.end_date ? new Date(otherTech.end_date) : /* @__PURE__ */ new Date();
  ...
  if (type === "technologies") {
    items.sort(function(a, b) {
      var aStart = a.start_date ? new Date(a.start_date) : /* @__PURE__ */ new Date();
      var bStart = b.start_date ? new Date(b.start_date) : /* @__PURE__ */ new Date();
  ...
  var setStartDate = function setStartDate2(d) {
    if (d === void 0) {
      d = "";
    }
  ...
  var setEndDate = function setEndDate2(d) {
    if (d === void 0) {
      d = "";
    }
    endDate = new Date(d);
  ...
  items.forEach(function(item) {
    ...
    var itemEndDate = item.is_current ? /* @__PURE__ */ new Date() : new Date(item.end_date);
    if (itemStartDate < startDate)
      setStartDate(itemStartDate);
    if (!endDate || itemEndDate > endDate)
      setEndDate(itemEndDate);
  });
  var itemsWithCols = [];
  items.forEach(function(item, index) {
    ...
    if (!totalCols || itemEndCol > totalCols)
      totalCols = itemEndCol;
    itemsWithCols.push(_extends2({
  ...
  var getRowIndex = function getRowIndex2(item, rowIndex) {
    ...
    if (hasClash) {
      rowIndex += 1;
      return getRowIndex2(item, rowIndex);
    }
    return rowIndex;
  };
  ...
  var getYears = function getYears2() {
...
// node_modules/@codersrank/timeline/esm/shared/string-to-color.js
...
// node_modules/@codersrank/timeline/esm/shared/company-logo.js
var companyLogo = function companyLogo2(name, url) {
  var iconColor = stringToColor(name || "");
  return url ? (
    /* html */
...
// node_modules/@codersrank/timeline/esm/shared/sanitize-description.js
var sanitizeDescription = function sanitizeDescription2(html) {
  if (html === void 0) {
    html = "";
  }
...
// node_modules/@codersrank/timeline/esm/shared/render-tooltip.js
var renderTooltip = function renderTooltip2(item, type) {
  var formatLocation = function formatLocation2(_ref) {
    var location = _ref.location, is_remote = _ref.is_remote;
    if (location === "Remote, Earth" || is_remote)
      return "Remote";
    return location || "";
  };
  ...
  var formatInterval = function formatInterval2(months) {
    var output = "";
    if (months === 0)
  ...
  var calculateMonths = function calculateMonths2(startDate, endDate, is_current) {
    var end = is_current ? /* @__PURE__ */ new Date() : new Date(endDate);
    return differenceInMonths(new Date(startDate), end);
  };
  var dates = function dates2(showInterval) {
  ...
  var itemLogo = function itemLogo2() {
    if (type === "technologies") {
  ...
  var itemTitle = function itemTitle2() {
    return type === "workexperience" ? item.company : item.project_title;
  };
  var itemSubtitle = function itemSubtitle2() {
  ...
  if (type === "technologies") {
    return (
      ...
      '\n      <div class="codersrank-timeline-tooltip-item">\n        <div class="logo">\n          ' + itemLogo() + '\n        </div>\n        <div class="content">\n          <div class="title">\n            ' + item.name + '\n          </div>\n          <div class="details">\n            <div>' + dates(true) + '</div>\n          </div>\n        </div>\n      </div>\n      <div class="codersrank-timeline-tooltip-divider"></div>\n      ' + item.items.map(function(subItem) {
        return renderTooltip2(subItem, subItem._type);
      }).join("") + "\n    "
    );
  }
  return (
...
// node_modules/@codersrank/timeline/esm/codersrank-timeline.js
...
var CodersrankTimeline = function(_HTMLElement) {
  ...
  var _proto = CodersrankTimeline2.prototype;
  _proto.render = function render3() {
    var username = this.username, mounted = this.mounted, state = this.state, shadowEl = this.shadowEl, data = this.data, type = this.type, branding = this.branding;
    var ctx = {
      data,
      type,
      branding
  ...
  _proto.loadAndRender = function loadAndRender() {
    var _this2 = this;
    var username = this.username, type = this.type;
  ...
  _proto.showTooltip = function showTooltip(id) {
    ...
    if (left < 0)
      left = 0;
    if (left > widgetElRect.width)
      left = widgetElRect.width;
  ...
  _proto.onWidgetClick = function onWidgetClick(e) {
    ...
    if (itemEl)
      this.showTooltip(itemEl.getAttribute("data-id"));
  };
  ...
  _createClass(CodersrankTimeline2, [{
    key: "username",
    get: function get() {
  ...
  return CodersrankTimeline2;
}(_wrapNativeSuper(HTMLElement));
var codersrank_timeline_default = CodersrankTimeline;
export {
  codersrank_timeline_default as default
};
//# sourceMappingURL=@codersrank_timeline.js.map
